...
namespace Homework_01
{
    ...
    class Repository
    {
        ...
        /// <summary>
        /// Удаляем случайного работника
        /// </summary>
        /// <returns>
        /// информацию об удаленном работнике
        /// </returns>
        public string DeleteRandomWorker()
        {
            int random_i = Repository.randomize.Next(this.Workers.Count);
            string info = this.Workers[random_i].ToString();
            this.Workers.RemoveAt(random_i);
            return info;
        }
    }
}
